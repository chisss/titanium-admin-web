...
**走查覆盖**：成功 38 页 / 异常 4 项，基线截图 **42 张**已本地留存于 `docs/ui-audit/baseline-20260917/`（**未入库**，见下方说明）。
...
> 🔴 **截图不入库（2026-09-20 起）**：走查截图属**过程证据**，体积大且非源码，已加入 `.gitignore` 并从 git 历史中剥离。
> 本节索引保留以说明**当时拍过哪些页/态**；文件本身**仅在拍摄者本机留存**，克隆仓库后**取不到**。
> 需要复核时按**下表**的页/态清单**重新拍摄**即可，索引即是重拍脚本的输入。
